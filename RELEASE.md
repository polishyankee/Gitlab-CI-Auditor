...
- `gitlab-ci-auditor:v0.5.0`
- `ghcr.io/polishyankee/gitlab-ci-auditor:v0.5.0`

It also smoke-tests the image with:

```bash
docker run --rm gitlab-ci-auditor:v0.5.0 scan /app/examples/pipelines/compliant_service.gitlab-ci.yml
```
...
3. Provide the version string, for example `v0.5.0`.
...
```bash
docker pull ghcr.io/polishyankee/gitlab-ci-auditor:v0.5.0
docker run --rm ghcr.io/polishyankee/gitlab-ci-auditor:v0.5.0 scan /app/examples/pipelines/compliant_service.gitlab-ci.yml
```
