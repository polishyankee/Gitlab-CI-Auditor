      ...
      RequestStub.new(
        {
          "pipeline_directory_files" => [
            UploadStub.new(".gitlab-ci.yml", root_pipeline),
            UploadStub.new(".gitlab/ci/templates/prepare.yml", template_pipeline)
          ],
  ...
  def test_analyze_request_rewrites_incomplete_upload_bundle_errors
    ...
    error = assert_raises(ArgumentError) do
      server.send(
        ...
        RequestStub.new(
          {
            "pipeline_file" => UploadStub.new(".gitlab-ci.yml", root_pipeline),
            "policy_pack" => "balanced"
          }
        )
      )
